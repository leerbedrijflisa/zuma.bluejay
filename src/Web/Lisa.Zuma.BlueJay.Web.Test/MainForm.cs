...
namespace Lisa.Zuma.BlueJay.Web.Test
{
    public partial class MainForm : Form
    {
        ...
        private void btnSubmitNote_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("A message is required!"); 
                return;
            }
            ...
            {
                var path = boxItems.FirstOrDefault(item => item.Contains(media.Name));
        ...
        private async void Store(NoteMedia media, string path, int noteId)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                using (var fileStream = File.OpenRead(path))
                {
                    ...
                    content.Headers.Add("Content-Type", MimeTypes[extension]);
